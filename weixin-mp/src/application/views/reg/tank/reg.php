    ...
    <section class="page page2 z-current">
        <section class="box">
        	<section class="reg-cont">
                ...
                <h3><img src="<?php echo base_url();?>assets/tank/images/3131.png" alt=""></h3>
                <section class="icon">
                	<li><img src="<?php echo base_url();?>assets/tank/images/icon-1.png" alt=""><h2>配件改造包*10</h2></li>
                    <li><img src="<?php echo base_url();?>assets/tank/images/icon-2.png" alt=""><h2>统帅书*3</h2></li>
                    <li><img src="<?php echo base_url();?>assets/tank/images/icon-3.png" alt=""><h2>荣誉勋章*20</h2></li>
                    <li><img src="<?php echo base_url();?>assets/tank/images/icon-4.png" alt=""><h2>精良配件箱*1</h2></li>
                    <li><img src="<?php echo base_url();?>assets/tank/images/icon-5.png" alt=""><h2>T-90*20</h2></li>
                </section>
                <section class="submit"><input name="submit" type="image" src="<?php echo base_url();?>assets/tank/images/submit.gif" id="submit" onClick="return checkform();"></section>
                </form>
            </section>
        </section>
    </section>
